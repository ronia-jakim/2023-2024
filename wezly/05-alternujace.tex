...
Najprostszy (o najmniejszej liczbie skrzyżowań) węzeł niealternujący to np. $8_{19}$ (ale też $8_{20}$ i $8_{21}$), który widać na \cref{diagram 8 19}. Do pokazania, że naprawdę nie kłamię jeśli chodzi o jego niealternującą naturę, wrócimy niżej.
%Do pokazania, że naprawdę nie kłamię jeśli chodzi o jego niealternującą naturę, wrócimy przy okazji powierzchni Seiferta i \emph{sygnatury węzła}.
...
\begin{proof}
  ...
  Pierwszy przypadek jest prosty. W drugim pakujemy cały rysunek $K_2$ w zielony obszar i przyklejamy go w środek diagramu $K_1$.
  \begin{figure}[h]\centering
    \begin{tikzpicture}
      \begin{scope}[shift={(0, -7)}]
        \begin{scope}[shift={(3.5, 0)}, scale=0.7]
          ...
          \draw[very thick, red] (2, -1)--(3.3, -1);
          \draw[very thick, blue] (2, -2)--(3.6, -2);

          \draw[dashed, green] (-1, -4.3)--(-1, 1)--(1.5, 1)--(2.5, -.5)--(2.5, -2.5)
            --(1.5, -4.3)--(-1, -4.3);
        \end{scope}

        \begin{scope}[rotate around = {-90:(7,.5)}, yscale=3, xscale=2]
          \draw (5, -2)--(4, -2.3)--(4, -3.5)--(5, -3.8);
          ...
          \draw[white, ultra thick] (4, -0.25)--(3.9+1.1/2+0.1, -0.25/2-0.05/4+0.025);
          \draw[dashed, very thick] (4, -0.25)--(3.9+1.1/2+0.1, -0.25/2-0.05/4+0.025);
        \end{scope}
    ...
    \begin{tikzpicture}
      ...
      \begin{knot}[ 
        ...
        \strand[very thick] 
          ...
          (3, -4) to 
          (0, -4);
        \strand[very thick] (4, -.5)--(4, -2);
        \strand[very thick] (1, 0)--(2, 0)--(2.5, 0.5);
      \end{knot}
...
Węzeł $8_{19}$, który pokazywaliśmy już wyżej na \cref{diagram 8 19}, ma wielomian Jonesa
$$-t^8+t^5+t^3.$$
To znaczy, że $span(8_{19})=5<8$. Dokładnie przeglądając węzły o co najwyżej $5$ skrzyżowaniach zobaczymy, że żaden nie dzieli z $8_{19}$ wielomianu Jonesa. Stąd, $8_{19}$ nie ma zredukowanego diagramu alternującego, a więc nie ma ani jednego diagramu alternującego.
