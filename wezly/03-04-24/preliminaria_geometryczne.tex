...
\begin{frame}{Homeomorfizm}{na trójkącikach}
  Normalnie dwie przestrzenie topologiczne są homeomorficzne, jeśli istnieje ciągła bijekcja między nimi (i ciągła bijekcja doń odwrotna).
...
\begin{frame}{Po co nam te trójkąciki?}
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{tikzpicture}
        \node at (2,0) {\includegraphics[width=0.6\textwidth]{10_128_wielokatny.png}};
        \node at (0, -3) {\includegraphics[width=0.6\textwidth]{10_128_gladki.png}};
      \end{tikzpicture}
    \end{column}
  \end{columns}
