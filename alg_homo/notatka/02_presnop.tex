...
\begin{definition}[równoważność kategorii]
  Funktor $F:\mathbf{C}\to\mathbf{D}$ zadaje \buff{równoważność kategorii}, jeśli istnieje $G:\mathbf{D}\to\mathbf{C}$ takie, że $F\circ G=id_{\mathbf{D}}$ i $G\circ F=id_{\mathbf{C}}$
\end{definition}
