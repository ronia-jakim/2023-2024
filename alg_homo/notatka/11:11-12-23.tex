...
\begin{lemma}
  ...
  \begin{center}\begin{tikzcd} 
    ...\arrow[r] & Hom(U, X[i]) \arrow[r] & Hom(U, Y[i]) \arrow[r] & Hom(U, Z[i])\arrow[dll] \\ 
                 & Hom(U, X[i+1]) \arrow[r] & ...
  \end{tikzcd}\end{center}
  ...
  \begin{center}\begin{tikzcd}
    ...\arrow[r] & Hom(Z[i], U)\arrow[r] & Hom(Y[i], U)\arrow[r] & Hom(X[i], U)\arrow[dll]\\ 
                 & Hom(Z[i-1], U)\arrow[r] & ...
  \end{tikzcd}\end{center}
\end{lemma}
...
\begin{proof}
  ...
  \begin{center}\begin{tikzcd}
    X\arrow[r, "\alpha"]\arrow[dr, "\alpha^*\beta^*f"] & Y\arrow[r, "\beta"]\arrow[d, "\beta^*f"] & Z\arrow[dl, "f"]\\ 
                                                       & W
  \end{tikzcd}\end{center}
