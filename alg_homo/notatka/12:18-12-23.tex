\section{Kompleksy podwójne, totalne i inne przymiotniki}
...
\begin{proof}
  ...
  \begin{center}\begin{tikzcd}
    H^i(X^*)\arrow[r] & H^i(Y^*)\arrow[r] & H^i(C(f))\arrow[r] & H^{i+1}(X^*)\arrow[r] & ... 
  \end{tikzcd}\end{center}

  Niech $g:C^*\to I^*$ będzie $C^*$-acykliczny. Zbudujemy $h:C^*\to I^*[-1]$ takie, że $g^i=dh^i+h^{i+1}d$ indukcyjnie. Dla $i\leq 0$ mamy $h^i=0$. 

  \begin{center}\begin{tikzcd}
    \arrow[r] & C^{i-1}\arrow[r]\arrow[d, "g^{i-1}"] & C^i\arrow[r]\arrow[d, "g^i"]\arrow[dl, "h^i"] & C^{i+1}\arrow[dl, "h^{i+1}"]\\ 
    \arrow[r] & I^{i-1}\arrow[r, "d"] & I^i\arrow[r] & I^{i+1}
  \end{tikzcd}\end{center}
  ...
  Mamy więc
  \begin{center}\begin{tikzcd}
    0\arrow[r] & \coker d^{i-1}_c \arrow[r] \arrow[d, "g^i-dh^i"] & C^{i+1}\arrow[dl, "h^{i+1}", blue] \\ 
               & I^i
  \end{tikzcd}\end{center}
...
\begin{proof}
  ...
  \begin{definition}[rezolwenta Cartana-Eilebnerga]
    ...
    \tikz[overlay]{
      \filldraw[fill=yellow!15, draw=orange!60, thick, rounded corners](4.6, -0.4) rectangle (5.7, -5.5);
    }
    \begin{center}\begin{tikzcd}
      ... & ... & ... \\ 
...
\begin{definition}[funktor pochodny]
  ...
  \begin{center}\begin{tikzcd}
    K^+(\mathbf{I}_A)\arrow[dr, yshift=-1mm]\arr[r, hookrightarrow] & K^+(\mathbf{A}) \arrow[r, "K(F)"]\arrow[d] & K^+(\mathbf{B})\arrow[d]\\
